      ...
      <div className="mx-auto max-w-7xl px-6 py-16 lg:px-10">
        <div className="grid gap-12 md:grid-cols-4">
          <div className="md:col-span-2">
            ...
            <div className="mt-6 flex gap-4">
              <a
                href="https://www.instagram.com/lokaviainternational/?hl=en"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Lokavia International on Instagram"
                className="flex h-9 w-9 items-center justify-center rounded-full border border-white/10 text-gray-400 transition-colors hover:border-white/30 hover:text-white"
              >
                {/* Instagram */}
              ...
              <a
                href="https://www.linkedin.com/company/lokavia-international/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Lokavia International on LinkedIn"
                className="flex h-9 w-9 items-center justify-center rounded-full border border-white/10 text-gray-400 transition-colors hover:border-white/30 hover:text-white"
              >
                {/* LinkedIn */}
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
              ...
              <a
                href="https://www.facebook.com/profile.php?id=61592642647463"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Lokavia International on Facebook"
                className="flex h-9 w-9 items-center justify-center rounded-full border border-white/10 text-gray-400 transition-colors hover:border-white/30 hover:text-white"
              >
                {/* Facebook */}
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
              ...
              <a
                href="https://x.com/Lokaviainter"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Lokavia International on X"
                className="flex h-9 w-9 items-center justify-center rounded-full border border-white/10 text-gray-400 transition-colors hover:border-white/30 hover:text-white"
              >
                {/* X (Twitter) */}
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
        ...
        <div className="mt-16 flex flex-col justify-between gap-4 border-t border-white/10 pt-8 text-xs text-gray-400 md:flex-row">
          ...
          <div className="flex flex-wrap gap-x-6 gap-y-2">
            ...
            <span>
              <TextHighlight>Currently Serving B2B Buyers Only.</TextHighlight>
            </span>
          </div>
        </div>
      </div>
